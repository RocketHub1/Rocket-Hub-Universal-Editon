...
local Window = Library.CreateLib("Rocket Hub", "Midnight")
...
MainSection:NewToggle("Run Fast", "Go Very Fast", function(state)
    if state then
...
MainSection:NewButton("God Mode", "Makes You Invinsible", function()
...
PlayerSection:NewSlider("Jump Power", "Makes You Jump Higher", 500, 50, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
end)
PlayerSection:NewSlider("Walk Speed", "Makes You Walk Faster", 500, 16, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)


PlayerSection:NewButton("Headless Troll", "Gives You Headless for free", function()
